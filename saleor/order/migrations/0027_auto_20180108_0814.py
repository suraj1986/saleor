...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='account.Address'),
        ),
        migrations.AlterField(
            model_name='order',
            name='created',
        ...
        migrations.AlterField(
            model_name='orderhistoryentry',
            name='status',
            field=models.CharField(choices=[('open', 'Open'), ('closed', 'Closed')], max_length=32),
        ),
        migrations.AlterField(
            model_name='orderhistoryentry',
            name='user',
        ...
        migrations.AlterField(
            ...
            name='delivery_group',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='lines', to='order.DeliveryGroup'),
        ),
        migrations.AlterField(
            model_name='orderline',
            name='product',
        ...
        migrations.AlterField(
            model_name='orderline',
            name='stock',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='product.Stock'),
        ),
        migrations.AlterField(
            model_name='orderline',
            name='stock_location',
        ...
        migrations.AlterField(
            model_name='payment',
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='payments', to='order.Order'),
        ),
    ]
